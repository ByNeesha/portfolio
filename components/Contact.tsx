...
//             <p className="text-2xl">neesha@live.nl</p>
//           </div>
//           <div className="flex items-center space-x-5 justify-center">
//             <MapPinIcon className="text-green-500 h-7 w-7 animate-pulse" />
//             <p className="text-2xl">Delft</p>
...
//           <button className="bg-green-500/50 py-5 px-10 rouned-md text-gray-400 font-bold text-lg  focus:bg-green-500 focus:text-gray-900 hover:bg-green-500 hover:text-gray-900">
//             Verzend
//           </button>
//         </form>
//       </div>
